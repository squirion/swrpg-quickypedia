...
class StarshipTile extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final rarity = _parseRarity(starship.rarity);
    ...
    final secondaryValue = secondaryAttr == null
        ? null
        : _displayValue(starship, secondaryAttr);

    final authHeaders = starship.imageUrl == null
        ? null
        : githubAuthHeadersFor(starship.imageUrl!, ref);
          ...
          child: ClipRRect(
            ...
            child: Stack(
              ...
              children: [
                ...
                if (starship.price != null)
                  Positioned(
                    bottom: 6,
                    right: 8,
                    child: _PriceBadge(price: starship.price!),
                  ),
...
class _Background extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return CachedNetworkImage(
      ...
      errorWidget: (_, _, _) => const StarshipPlaceholder(),
    );
  }
}
...
String? _displayValue(Starship s, StarshipSortAttr attr) => switch (attr) {
      StarshipSortAttr.rarity => s.rarity,
      StarshipSortAttr.price => s.price,
      StarshipSortAttr.silhouette => s.silhouette,
      StarshipSortAttr.speed => s.speed,
      StarshipSortAttr.handling => s.handling,
      StarshipSortAttr.armor => s.armor,
